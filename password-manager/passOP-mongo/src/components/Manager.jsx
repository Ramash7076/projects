    ...
    return (
        ...
        bg-[size:14px_24px]">
          ...
          w-[310px] rounded-full bg-green-400 opacity-20 blur-[100px]"></div>
            ...
            <div className="md:w-[80vw] md:px-40 md:py-16 md:mx-auto p-3 md:p-0 min-h-[calc(100vh-120px)]">
                <h1 className='font-bold text-4xl text-center'>
                    <span className='text-green-500'>&lt;</span>
                    <span>Pass</span>
                    <span className='text-green-500'>OP/&gt;</span>
                ...
                <div className="flex flex-col items-center p-4 text-black gap-8">
                    ...
                    <button onClick={savePassword} className='flex justify-center items-center bg-green-500 gap-2 hover:bg-green-600 w-full md:w-fit rounded-full px-8 py-2 border border-green-900'>
                ...
                <div className="passwords w-full overflow-x-auto">
                    ...
                    {passwordArray.length === 0 ? (
                        ...
                        <div>
                            <table className="table-auto w-full table rounded-md overflow-hidden mb-10">
                                <thead className='bg-green-700 text-white'>
                                    <tr>
                                        <th className='py-2'>Site</th>
                                        <th className='py-2'>Username</th>
